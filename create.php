    ...
    <div class="wrap">
        <form class="add-form" method="post" action="./handle.php">
            ...
            ?>
                <div class="form-group">
                    <h5>Name Company</h5>
                    <input type="text" name="name_company" id="name_company" class="form-input" value="<?php echo $person['name_company'] ?>">
                </div>
                ...
                <div class="form-group">
                    <h5>Position</h5>
                    <input type="text" name="position" id="position" class="form-input" value="<?php echo $person['position'] ?>">
                </div>
                <input type="hidden" name="id" value="<?php echo $id ?>">
